...
public class TooleCrossbow extends ItemBow
{
    public TooleCrossbow()
    {
        this.maxStackSize = 1;
    ...
    public TooleCrossbow(String string, Object object) {
		// TODO Auto-generated constructor stub
	}

	public void ToolCrossbow(String string, Object object) {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
    {
        if(!worldIn.isRemote && entityLiving instanceof EntityPlayer)
        {
            ...
            {
                if(slot.getStack().getItem() == ModItems.CROSSBOW)
                {
    ...
    {
        if(!worldIn.isRemote && entityLiving instanceof EntityPlayer)
        {((EntityPlayer)entityLiving).addItemStackToInventory(new ItemStack(ModItems.CROSSBOW2));
        for(Slot slot : ((EntityPlayer)entityLiving).inventoryContainer.inventorySlots)
        {
