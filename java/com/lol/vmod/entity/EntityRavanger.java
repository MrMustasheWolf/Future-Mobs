...
import com.lol.vmod.entity.ai.EntityAIRavangerAttack;
...
import com.lol.vmod.entity.ai.EntityAINearestAttackableTarget;
...
public class EntityRavanger extends EntityMob
{
    ...
    private static final DataParameter<Boolean> IS_CHILD = EntityDataManager.<Boolean>createKey(EntityRavanger.class, DataSerializers.BOOLEAN);
    /**
     * Was the type of villager for zombie villagers prior to 1.11. Now unused. Use {@link
     * EntityZombieVillager#PROFESSION} instead.
     */
    private static final DataParameter<Integer> VILLAGER_TYPE = EntityDataManager.<Integer>createKey(EntityRavanger.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.<Boolean>createKey(EntityRavanger.class, DataSerializers.BOOLEAN);
    ...
    public EntityRavanger(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(2, new EntityAIRavangerAttack(this, 1.0D, false));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityRavanger.class);
    }
	...
	public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new EntityRavanger.GroupData(false));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata == null)
        {
            livingdata = new EntityRavanger.GroupData(this.world.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance);
        }

        if (livingdata instanceof EntityRavanger.GroupData)
        {
            EntityRavanger.GroupData entityzombie$groupdata = (EntityRavanger.GroupData)livingdata;
    ...
    private void multiplySize(float f) {
