...
public class BeeEntity extends EntityWolf
{
    private static final DataParameter<Byte> HANGING = EntityDataManager.<Byte>createKey(BeeEntity.class, DataSerializers.BYTE);
    ...
    {
        EntityLiving.registerFixesMob(fixer, BeeEntity.class);
    }
    ...
    public BeeEntity  createChild(EntityAgeable ageable)
    {
    	BeeEntity BeeEntity = new BeeEntity(this.world);
        UUID uuid = this.getOwnerId();

        if (uuid != null)
        {
        	BeeEntity.setOwnerId(uuid);
        	BeeEntity.setTamed(true);
        }
